...
func allPageReadContracts() map[string]readmodel.Contract {
	return map[string]readmodel.Contract{
		...
		"/api/code-reviews/{id}":                   detailRead("code-review-detail", readmodel.MaturityBounded, 1, "tasks.review"),
		"/api/daily-jira-email/candidate-owners":   detailRead("daily-jira-email-candidate-owners", readmodel.MaturityBounded, 1000, "settings.email"),
		"/api/daily-jira-email/runs":               detailRead("daily-jira-email-runs", readmodel.MaturityBounded, 14, "settings.email"),
		"/api/daily-jira-email/templates":          detailRead("daily-jira-email-templates", readmodel.MaturityBounded, 34, "settings.email"),
		...
		"/api/projects/catalog":                    directoryRead("project-catalog", readmodel.MaturityBounded, "settings.projects", "settings.email"),
		...
		"/api/strongest-brain/review-intelligence": aggregateRead("review-intelligence", readmodel.MaturityBounded, "decision.agenda", "evidence.health"),
